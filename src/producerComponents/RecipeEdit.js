...
const RecipeEdit = ({ editrecipe, onCancel }) => {
  ...
  const [selectedIngredients, setSelectedIngredients] = useState(
    editrecipe.items.map((item) => ({
      itemId: item.item.id,
      itemName: item.item.name,
      costPerQuantity: item.item.price,
  ...
  return (
    <div className="flex justify-center ">
      <div className="fixed z-10  top-36 bg-gray-200  shadow-xl shadow-black w-44rem h-44rem p-4 overflow-y-auto ">
        <h2 className="text-3xl font-bold mb-4 text-center">Recipe Edit</h2>
              ...
              {selectedIngredients.map((ingredient, index) => (
                <tr key={index} className="bg-white">
                  ...
                  <td className="px-4 py-2 border">
                    <button
                      onClick={() =>
                        handleDeleteIngredient(ingredient.itemName)
                      }
        ...
        <div className="flex flex-row justify-between">
          <button
            ...
            className="bg-thirtiary hover:bg-thirtiaryD text-white font-bold py-2 px-4 mt-10 rounded focus:outline-none focus:shadow-outline ">
            Submit
          </button>
          <button
            className="bg-gray-300 mt-10 hover:bg-gray-400 text-gray-800 shadow-md px-4 py-2"
            onClick={onCancel}>
            Cancel
          </button>
        </div>
